...
namespace Framework.WebCore.FilterExtend
{
    public class LogActionFilterAttribute : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            _logger.LogInformation($"url={url}---argument={argument}");
        }
    }
    ...
    public class CustomActionFilterAttribute : ActionFilterAttribute
    {
        ...
        {
            Console.WriteLine($"This {nameof(LogActionFilterAttribute)} OnActionExecuted{Order}");
        }
        public override void OnActionExecuting(ActionExecutingContext context)
        {
            Console.WriteLine($"This {nameof(LogActionFilterAttribute)} OnActionExecuting{Order}");
        }
        public override void OnResultExecuting(ResultExecutingContext context)
        {
            Console.WriteLine($"This {nameof(LogActionFilterAttribute)} OnResultExecuting{Order}");
        }
        public override void OnResultExecuted(ResultExecutedContext context)
        {
            Console.WriteLine($"This {nameof(LogActionFilterAttribute)} OnResultExecuted{Order}");
        }
    }
